...
const Navbar = ({ refs }) => {
  ...
  return (
    <nav className="flex justify-between items-center px-8 py-2 bg-gray-900 text-white">
    <div className="flex items-center">
      <img
        src="images/fp_splash.png"
        alt="FP logo"
        className="h-18 w-10 object-contain" // Adjusts height and keeps aspect ratio
      />
    </div>
    <ul className="flex gap-4 sm:gap-6 md:gap-8 text-sm">
